...
public class WeatherController {
    ...
    @GetMapping(value = "/greatThen/{value}", produces = MediaType.TEXT_EVENT_STREAM_VALUE)
    public Flux<Weather> greatThen(@PathVariable Integer value) {
        return weathers.greatThen(value);
    }
}
